...
const Footer = () => {
    return (
        <footer className="bg-white mx-auto px-4 md:px-8 py-5 max-w-screen-xl text-gray-500">
            <div className="md:flex justify-between gap-6">
                ...
                <div className="sm:flex flex-1 justify-between items-center space-y-6 md:space-y-0 mt-10 md:mt-0">
                    <ul
                        className="space-y-4"
                    >
                        <h4 className="font-medium text-gray-800">Services</h4>
                        {
                            services.map(((el, idx) => (
                                <li key={idx}>
                                    <a
                                        href={el.href}
                                        className="hover:text-indigo-600 hover:underline hover:cursor-pointer"
                    ...
                    <ul
                        className="space-y-4"
                    >
                        <h4 className="md:ml-12 font-medium text-gray-800">Get in touch</h4>
                        <li className="flex items-center gap-4">
                            <div className="flex justify-center items-center bg-indigo-600 rounded-full w-7 h-7">
